...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        std::cout << std::string(70, '-') << std::endl;
        std::cout << "   Range requests allow downloading only the bytes you need." << std::endl;
        std::cout << "   This is efficient for large files when you only need a portion." << std::endl;
        std::cout << std::endl;
        ...
        std::cout << "   → Use case: Reading file headers or metadata" << std::endl;
        std::cout << std::endl;
        ...
        std::cout << "   → Use case: Accessing specific file sections" << std::endl;
        std::cout << std::endl;
        ...
        std::cout << "   → Use case: Reading file trailers or recent data" << std::endl;
        std::cout << std::endl;
        ...
        std::cout << "   → Use case: Resuming downloads or processing file tails" << std::endl;
        std::cout << std::endl;
        ...
        std::cout << "   → Use case: Resuming large file downloads after interruption" << std::endl;
        std::cout << std::endl;
        ...
        std::cout << "   → Use case: Memory-efficient processing of large files" << std::endl;
        std::cout << std::endl;
        ...
        std::cout << "   → Use case: High-performance downloads for large files" << std::endl;
        std::cout << std::endl;
        ...
        std::cout << "   → Use case: Reading file headers, metadata, or magic numbers" << std::endl;
        std::cout << std::endl;
        ...
        std::cout << "   → Use case: Processing specific file sections" << std::endl;
        std::cout << std::endl;
        ...
        std::cout << "   → Use case: Reading file trailers, checksums, or end markers" << std::endl;
        std::cout << std::endl;

        // ====================================================================
        // EXAMPLE 7: Streaming Pattern (Simulated)
        // ====================================================================
        std::cout << "9. Streaming Pattern (Simulated)" << std::endl;
        std::cout << std::string(70, '-') << std::endl;
        std::cout << "   Simulating streaming by downloading sequential chunks." << std::endl;
        std::cout << std::endl;

        const int64_t stream_chunk_size = 500;
        int64_t stream_offset = 0;
        int chunk_num = 0;

        std::cout << "   Streaming file in " << stream_chunk_size << " byte chunks..." << std::endl;
        while (stream_offset < file_size) {
            int64_t length = std::min(stream_chunk_size, file_size - stream_offset);
            std::vector<uint8_t> stream_chunk = client.download_file_range(file_id, stream_offset, length);
            
            chunk_num++;
            if (chunk_num <= 3 || stream_offset + length >= file_size) {
                std::cout << "   → Chunk " << chunk_num << ": offset=" << stream_offset 
                          << ", size=" << stream_chunk.size() << " bytes" << std::endl;
            }
            
            stream_offset += length;
        }
        std::cout << "   ✓ Streamed " << chunk_num << " chunks" << std::endl;
        std::cout << "   → Use case: Processing files as they arrive (streaming)" << std::endl;
        std::cout << std::endl;

        // ====================================================================
        // CLEANUP
        // ====================================================================
        std::cout << "10. Cleaning up test file..." << std::endl;
        ...
        std::cout << "  ✓ Download specific byte ranges" << std::endl;
        std::cout << "  ✓ Download from offset to end of file" << std::endl;
        std::cout << "  ✓ Resumable download patterns" << std::endl;
        std::cout << "  ✓ Chunked download for memory efficiency" << std::endl;
        ...
        std::cout << "  ✓ Streaming pattern simulation" << std::endl;
        std::cout << "  ✓ Data verification and validation" << std::endl;
